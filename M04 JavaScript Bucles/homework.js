...
function fizzBuzz(num) {
   ...
   // De lo contrario, retorna false.
   // Tu código:
   if (num/3==Math.round(num/3) && num/5==Math.round(num/5)) {
      console.log('fizzbuzz')}
         ...
         console.log('buzz')}
            ...
            console.log(num/5==Math.round(num/5))
...
console.log(operadoresLogicos(3,5,4))
...
function tieneTresDigitos(num) {
   ...
   // Tu código:
   if(num>99 && num<1000){
      console.log(num>99 && num<1000)
   }
   else{
      console.log(num>99 && num<1000)
   }
}
tieneTresDigitos(150)
